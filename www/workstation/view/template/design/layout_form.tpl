            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <option value="productblock" selected="selected"><?php echo $text_productblock; ?></option>
                    <?php } else { ?>
                    <option value="productblock"><?php echo $text_productblock; ?></option>
                    <?php } ?>	
					
					<?php if ($layout_module['position'] == 'newstext') { ?>
                    <option value="newstext" selected="selected"><?php echo $text_newstext; ?></option>
                    <?php } else { ?>
                    <option value="newstext"><?php echo $text_newstext; ?></option>
                    <?php } ?>
					
					<?php if ($layout_module['position'] == 'newscms') { ?>
                    <option value="newscms" selected="selected"><?php echo $text_newscms; ?></option>
                    <?php } else { ?>
                    <option value="newscms"><?php echo $text_newscms; ?></option>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="newstext"><?php echo $text_newstext; ?></option>';
	html += '    <option value="newscms"><?php echo $text_newscms; ?></option>';
	html += '    <option value="headertop"><?php echo $text_headertop; ?></option>';	
	html += '    <option value="productblock"><?php echo $text_productblock; ?></option>';
