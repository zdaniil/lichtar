		...
		<?php foreach( $filterItems as $item_id => $item ) { ?>
				<tr>
					<td>
						...
						<button type="button" class="btn btn-xs btn-info" data-mf-id="<?php echo $item['filter_group_id']; ?>" data-mf-action="set-tooltip" data-mf-idx="<?php echo $IDX; ?>" data-mf-type="filter_group"><?php echo $text_set_tooltip; ?></button>
					</td>
					<td>
