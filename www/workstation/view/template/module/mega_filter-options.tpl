		...
		<?php foreach( $optionItems as $item_id => $item ) { ?>
				<tr>
					<td style="width: auto;">
						...
						<button type="button" class="btn btn-xs btn-info" data-mf-id="<?php echo $item['option_id']; ?>" data-mf-action="set-tooltip" data-mf-idx="<?php echo $IDX; ?>" data-mf-type="option"><?php echo $text_set_tooltip; ?></button>
					</td>
