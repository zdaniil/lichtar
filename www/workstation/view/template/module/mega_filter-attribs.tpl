			...
			<?php foreach( $item['childs'] as $childKey => $child ) { ?>
				<tr>
					...
					<td class="vertical-middle text-center">
						...
						<?php echo mf_render_btn_group( $text_yes, $text_no, $_attribsName . '[' . $child['attribute_group_id'] . '][items][' . $child['attribute_id'] . '][enabled]', ! empty( $_attribsValues[$child['attribute_group_id']]['items'][$child['attribute_id']]['enabled'] ) ); ?><br /><br />						
						<button type="button" class="btn btn-xs btn-info" data-mf-id="<?php echo $child['attribute_id']; ?>" data-mf-action="set-tooltip" data-mf-idx="<?php echo $IDX; ?>" data-mf-type="attribute"><?php echo $text_set_tooltip; ?></button>
					</td>
					<td>
