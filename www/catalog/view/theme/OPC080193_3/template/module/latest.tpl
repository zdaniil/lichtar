<div class="box">
	...
	?>
        ...
        <div class="box-product <?php if ($productCount >= $sliderFor){ ?>product-carousel<?php }else{ ?> productbox-grid<?php }?>"
             id="<?php if ($productCount >= $sliderFor){ ?>популярное-carousel<?php }else{ ?>популярное-grid<?php }?>">
...
<span class="популярное_default_width" style="display:none; visibility:hidden"></span>
